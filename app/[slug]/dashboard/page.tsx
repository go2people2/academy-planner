...
import { getStudentStartTime, getStudentActiveHours, getPureFilteredStudents, filterStudentList } from './utils/dashboardFilters';
...
export default function DashboardPage() {
  ...
  // slug 변경 시 (A/B 학원 전환, Master Warp) filter ready 리셋
  useEffect(() => {
