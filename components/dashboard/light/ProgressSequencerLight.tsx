...
import BookProgressRowLight from './BookProgressRowLight';
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 bg-white px-4 py-2 rounded-full border border-[#e3e2e0] shadow-sm">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] font-black text-emerald-600 uppercase">처음풀기</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <div className="w-2 h-2 rounded-full bg-amber-500" />
                    <span className="text-[9px] font-black text-amber-600 uppercase">오답완료</span>
                  </div>
                  <div className="flex items-center gap-1.5">
