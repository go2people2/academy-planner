          ...
          <div className="flex items-center justify-center gap-1.5 px-1 py-1 w-full min-h-[22px] relative group/tools">
            ...
            {onViewDetail && (
              <button 
                ...
                className="p-1.5 bg-emerald-600/20 text-emerald-600 hover:bg-emerald-600 hover:text-white rounded-[4px] shrink-0 transition-colors"
                title="학생 프로필 서랍 열기"
              >
            ...
            <div onClick={onAttendanceClick} className={`absolute inset-0 w-full h-full flex items-center justify-start px-4 text-[11px] cursor-pointer select-none transition-colors hover:bg-[#edece9]/30 z-30 ${
              ...
              <div className="flex items-center gap-1.5">
                ...
                {formData.moved_to_hour && (
                  <span className="text-[9.5px] font-bold bg-blue-50 text-blue-650 px-1 rounded border border-blue-200">
