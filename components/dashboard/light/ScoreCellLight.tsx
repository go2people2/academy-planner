    ...
    <div className="relative w-full min-h-[22px] flex items-center justify-start group/score py-1 px-1">
      ...
      {!isEditing && !isActive && (
        <div 
          ...
          className="px-4 text-[14px] text-left text-emerald-600 font-semibold pr-4 w-full min-h-[22px] py-1 flex items-center justify-start cursor-text group-hover/td:bg-[#edece9]/10 transition-colors"
        >
