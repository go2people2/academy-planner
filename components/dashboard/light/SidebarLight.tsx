        ...
        <nav className="space-y-1">
          ...
          {menuOrder.map(id => {
            const menuMap: Record<string, any> = {
              ...
              studentEdit: <SidebarLink key="studentEdit" id="studentEdit" icon={<UserCog size={14} className="text-amber-600" />} label="학생정보수정" active={viewMode === 'studentEdit'} onClick={() => { setViewMode('studentEdit'); setSelectedFilter('All'); setSelectedTeacherId('All'); setSelectedDays([]); }} isDragging={draggedId === 'studentEdit'} onDragStart={handleDragStart} onDragOver={handleDragOver} onDragEnd={handleDragEnd} />,
