        ...
        <nav className="space-y-1">
          ...
          <div className="mb-2.5">
            <SidebarLink
              key="live"
              id="live"
              icon={<Zap size={14} className={isClassroomModeOpen ? "text-amber-500 fill-current animate-pulse" : "text-amber-500"} />}
              label="수업 시작 (LIVE)"
          ...
          <SidebarLink
            key="todayTable"
            id="todayTable"
            icon={<TableIcon size={14} className="text-sky-500" />}
            label="TodaySheet"
          ...
          <SidebarLink
            ...
            onClick={() => { setViewMode('studentSupport'); setSelectedFilter('All'); }}
          />
          ...
          {isFeatureEnabled(academyInfo, 'operations_tools') && (
            <SidebarLink
              ...
              icon={<Activity size={14} className="text-teal-500" />}
              label="운영 관리"
          ...
          <div className="px-1 space-y-3">
            ...
            {isAdmin && (
              <div className="pt-1">
                <div className="relative group">
                  {!isFilterReady ? (
                    <div className="w-full bg-white border border-[#edece9] rounded-[2px] py-2 px-3 h-[30px] flex items-center">
                      <div className="h-2.5 w-24 bg-[#edece9] rounded animate-pulse" />
                    </div>
                  ) : (
                    <select
                      value={selectedTeacherId}
                      onChange={(e) => setSelectedTeacherId(e.target.value)}
                      className="w-full bg-white border border-[#edece9] rounded-[2px] py-2 px-3 text-[10px] font-black text-[#37352f] outline-none appearance-none cursor-pointer hover:bg-[#edece9]/30 transition-all"
                    >
            ...
            <div className="pt-1">
              <div className="relative group">
                {!isFilterReady ? (
                  <div className="w-full bg-white border border-[#edece9] rounded-[2px] py-2 px-3 h-[30px] flex items-center">
                    <div className="h-2.5 w-20 bg-[#edece9] rounded animate-pulse" />
                  </div>
                ) : (
                  <select
                    value={selectedHour}
