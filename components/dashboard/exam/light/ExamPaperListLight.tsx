  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.topRow}>
        ...
        <button onClick={onCreateNew} style={{ ...styles.createBtn, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              ...
              {filteredExams.map((exam) => {
                ...
                return (
                  <tr key={exam.id} style={styles.tr}>
                    <td style={{ ...styles.td, fontWeight: 700, color: '#0c73e8' }} onClick={() => onSelect(exam)}>
                      {exam.exam_code || '-'}
                    </td>
                    ...
                    <td style={{ ...styles.td, fontWeight: 600, color: '#37352f' }}>
...
const styles: Record<string, React.CSSProperties> = {
  container: { color: '#37352f', fontFamily: "'Pretendard', sans-serif" },
  topRow: { display: 'flex', justifyContent: 'space-between', marginBottom: 16, gap: 12, flexWrap: 'wrap' },
  searchBox: { flex: 1, minWidth: 280 },
  searchInput: { width: '100%', height: 42, borderRadius: 8, border: '1.5px solid #edece9', background: '#ffffff', color: '#37352f', padding: '0 14px', fontSize: 14, outline: 'none' },
  createBtn: { background: '#0c73e8', color: '#fff', border: 'none', padding: '0 20px', borderRadius: 8, cursor: 'pointer', fontWeight: 600, fontSize: 14, height: 42 },
  filterGroup: { display: 'flex', gap: 12, background: '#ffffff', padding: 14, borderRadius: 12, border: '1px solid #e3e2e0', marginBottom: 16, flexWrap: 'wrap', alignItems: 'flex-end', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' },
  filterItem: { display: 'flex', flexDirection: 'column', gap: 4 },
  filterLabel: { fontSize: 11, color: '#6b7280', fontWeight: 600 },
  filterSelect: { height: 36, borderRadius: 6, border: '1px solid #edece9', background: '#ffffff', color: '#37352f', padding: '0 8px', fontSize: 13, minWidth: 90, outline: 'none', cursor: 'pointer', transition: 'border-color 0.15s' },
  clearBtn: { height: 36, background: '#f3f4f6', border: '1px solid #edece9', color: '#4b5563', padding: '0 12px', borderRadius: 6, cursor: 'pointer', fontSize: 12, fontWeight: 500 },
  countText: { fontSize: 13, color: '#6b7280', marginBottom: 10, textAlign: 'right' },
  statusBox: { background: '#ffffff', padding: 40, borderRadius: 12, textAlign: 'center', border: '1px solid #e3e2e0', color: '#6b7280', fontSize: 14 },
  tableContainer: { background: '#ffffff', borderRadius: 12, border: '1px solid #e3e2e0', overflow: 'hidden', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' },
  table: { width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: 13 },
  thRow: { background: '#f7f7f5', borderBottom: '1.5px solid #e3e2e0' },
  th: { padding: '14px 16px', fontWeight: 600, color: '#37352f' },
  tr: { borderBottom: '1px solid #edece9', cursor: 'pointer', transition: 'background 0.15s' },
  td: { padding: '14px 16px', color: '#37352f', verticalAlign: 'middle' },
  badge: { background: 'rgba(12,115,232,0.1)', color: '#0c73e8', padding: '2px 8px', borderRadius: 6, fontSize: 11, fontWeight: 600 },
  actionGroup: { display: 'flex', gap: 8 },
  editBtn: { background: '#f3f4f6', color: '#0c73e8', border: 'none', padding: '5px 10px', borderRadius: 4, cursor: 'pointer', fontSize: 12, fontWeight: 600 },
  answerKeyBtn: { background: '#f0fdf4', color: '#16a34a', border: 'none', padding: '5px 10px', borderRadius: 4, cursor: 'pointer', fontSize: 12, fontWeight: 600 },
  deleteBtn: { background: '#fef2f2', color: '#dc2626', border: 'none', padding: '5px 10px', borderRadius: 4, cursor: 'pointer', fontSize: 12, fontWeight: 600 },
  
  // 뱃지 버튼 스타일
  badgeBtnActive: { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(12,115,232,0.1)', color: '#0c73e8', border: '1px solid rgba(12,115,232,0.2)', padding: '3px 8px', borderRadius: 6, fontSize: 11, fontWeight: 700, textDecoration: 'none', cursor: 'pointer' },
  badgeBtnInactive: { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', background: '#f3f4f6', color: '#6b7280', border: '1px dashed #e3e2e0', padding: '3px 8px', borderRadius: 6, fontSize: 11, fontWeight: 600, cursor: 'pointer', transition: 'all 0.15s' },
  errorBadgeActive: { display: 'inline-flex', alignItems: 'center', background: 'rgba(239,68,68,0.1)', color: '#dc2626', border: '1px solid rgba(239,68,68,0.2)', padding: '2px 6px', borderRadius: 4, fontSize: 10, fontWeight: 700, cursor: 'pointer' },
  errorBadgeInactive: { display: 'inline-flex', alignItems: 'center', opacity: 0.3, cursor: 'pointer', fontSize: 10 },
};
