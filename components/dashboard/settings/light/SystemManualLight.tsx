  ...
  return (
    <div className="space-y-6 text-[#37352f]">
      ...
      <div 
        ...
        className="group relative p-5 rounded-2xl bg-gradient-to-r from-purple-50 via-white to-indigo-50 border border-purple-200 hover:border-purple-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 shadow-sm hover:shadow-md transition-all cursor-pointer overflow-hidden"
      >
        <div className="flex items-center gap-4 relative z-10 min-w-0">
          {/* 섬네일 미리보기 프리뷰 박스 */}
          <div className="relative w-24 h-16 sm:w-28 sm:h-18 rounded-lg bg-slate-900 border border-purple-300 flex items-center justify-center shrink-0 overflow-hidden group-hover:scale-105 transition-transform shadow-sm">
            <div className="absolute inset-0 bg-cover bg-center opacity-75" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400&q=80')" }} />
            <div className="relative z-10 w-9 h-9 rounded-full bg-purple-600 text-white flex items-center justify-center shadow-md group-hover:bg-purple-700 transition-colors">
          ...
          <div className="space-y-1 min-w-0">
            <div className="flex items-center gap-2">
              <span className="px-2 py-0.5 rounded text-[10px] font-black bg-purple-600 text-white uppercase tracking-wider shadow-xs">
                영상 매뉴얼
              </span>
              <h4 className="font-black text-sm text-purple-950 flex items-center gap-1.5 truncate">
                🎬 [수능/기출] 27번~49번 문항별 타임스탬프 해설 플레이어
              </h4>
            </div>
            <p className="text-xs text-purple-800 font-bold truncate">
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-700 text-white text-xs font-black transition-all shrink-0 shadow-md flex items-center gap-2 group-hover:scale-105"
        >
